...
def create_dataloaders(X_train=None, y_train=None, X_val=None, y_val=None, X_test=None, y_test=None, batch_size=32):
    # Create DataLoader objects only if the inputs are non-empty
    train_loader = None
    val_loader = None
    test_loader = None
