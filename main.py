...
X_denoised_train = [X_denoised_train_dict[f"X_denoised_train_{i}"] for i in range(2, 5)]
X_denoised_val = [X_denoised_val_dict[f"X_denoised_val_{i}"] for i in range(2, 5)]
X_denoised_test = [X_denoised_test_dict[f"X_denoised_test_{i}"] for i in range(2, 5)]
